...
const FULL_TABLE_DEFINITIONS = Object.freeze([
  ...
  direct("staff_salary_monthly", "员工薪资", "staff_salary_monthly", [["staff_name", "员工姓名", { ...T, source_field: null, required_for_restore: false }], ["salary_actual", "实际工资", M], ["bonus", "奖金", M], ["deduction", "扣款", M], ["notes", "备注", T], ["id", "ID", PK], ["staff_id", "员工ID", { ...I, nullable: false, is_relation_field: true }], ["month_key", "month_key", { ...D, nullable: false }]], { restore_order: 170 }),
  direct("staff_attendance", "员工考勤", "staff_attendance", [["staff_name", "员工姓名", { ...T, source_field: null, required_for_restore: false }], ["attendance_date", "考勤日期", { ...D, nullable: false }], ["status", "状态", { ...T, nullable: false, enum_values: ATTENDANCE_STATUSES }], ["pay_units", "计薪单位", N], ["hours", "工时", N], ["reason", "原因", T], ["notes", "备注", T], ["id", "ID", PK], ["staff_id", "员工ID", { ...I, nullable: false, is_relation_field: true }], ["month_key", "month_key", { ...D, nullable: false }], ["updated_at", "更新时间", DT]], { restore_order: 180 }),
